...
public interface OrderDAO {
	...
	public static final String getAllOrdersByForViewQry ="select o.order_id,o.hostel_id, o.order_cost,o.order_placed_date, o.order_cancel_amt, " +
			" o.order_cancel_date, o.order_start_date, o.order_end_date, c.email  from orders o" +
			" inner join customer c on c.customer_id = o.customer_id" +
			" where ";
	
	
	
	public static final String cancelOrderQry = "update orders set order_cancel_amt=:orderCanAmt, order_cancel_date = CURDATE(), active=0 where order_id=:orderId";
	...
	public static final String getRevenueByDatesQuery ="select sum(order_cost) as order_amount, sum(order_cancel_amt) as cancelled_amount from orders " ;
	...
	public static final String getOrdersForSearchServiceQuery = "select distinct(o.order_id) from orders o" +
			...
			" where o.active=1 and o.hostel_id=:hostelId and ob.bed_id=:bedId and " +
	...
	public static final String getCompleteOrderDetailsByIdQuery="select o.order_id, h.hostel_name, o.order_cost, o.order_cancel_amt,  " +
			"o.order_start_date, o.order_start_date, c.first_name, c.last_name,h.cancellation_hours_limit, h.cancellation_fee_percant" +
			" from orders o" +
			" inner join order_bed ob on o.order_id = ob.order_id" +			
			" inner join customer c on c.customer_id=o.customer_id" +
			" inner join hostel h on h.hostel_id = o.hostel_id"+
			" where o.order_id=:orderId and o.active=1";
